...
Title.Text = "Aimbot (Made by Testcombo da moon)"
Title.TextColor3 = Color3.fromRGB(0, 0, 0)
Title.TextSize = 13.300
 
Toggle.Name = "Clique para ativar o amor da moon"
...
local function PNHLOYF_fake_script() -- Toggle.LocalScript 
	...
	script.Parent.MouseButton1Click:Connect(function()
		if _G.aimbot == false then
			...
			script.Parent.Text = "Moon, casa comigo!"
			...
			script.Parent.Text = "Desative o amor!"
		end
	end)
